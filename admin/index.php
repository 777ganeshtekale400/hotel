...
<head>
  <meta charset="UTF-8">
  <title>PUNERI HOTEL ADMIN</title>
...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">PUNERI HOTEL HOMEPAGE</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM `login` WHERE usname= '$myusername' and pass = '$mypassword'";
